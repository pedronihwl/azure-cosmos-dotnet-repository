...
using DefaultCosmosVectorSearchProvider = Microsoft.Azure.CosmosRepository.Providers.DefaultCosmosVectorSearchProvider;
...
public static class ServiceCollectionExtensions
{
        ...
        Action<CosmosClientOptions>? additionalSetupAction = default)
    {
        ...
        services.AddLogging()
            ...
            .AddSingleton<ICosmosVectorSearchProvider, DefaultCosmosVectorSearchProvider>()
