...
public class ContainerOptionsBuilder(Type type)
{
    ...
    internal VectorSearchOptions? VectorSearchOptions { get; private set; }
    ...
    public ContainerOptionsBuilder WithVectorSearch(string path, Action<VectorSearchOptions>? vectorSearchOptions = null)
    {
        VectorSearchOptions options = VectorSearchOptions.Default;

        vectorSearchOptions?.Invoke(options);
