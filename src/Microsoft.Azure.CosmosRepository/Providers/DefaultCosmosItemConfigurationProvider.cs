...
class DefaultCosmosItemConfigurationProvider(
    ...
    ICosmosVectorSearchProvider cosmosVectorSearchProvider) : ICosmosItemConfigurationProvider
{
    ...
    private ItemConfiguration AddOptions(Type itemType)
    {
        ...
        var (policy, indexing) = cosmosVectorSearchProvider.GetVectorSearchConfiguration(itemType);
        ...
        return new ItemConfiguration(
            ...
            vectorEmbeddingPolicy: policy,
            vectorIndexingPolicy: indexing);
    }
}